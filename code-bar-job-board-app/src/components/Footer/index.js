        ...
        <footer className="main-footer container-fluid">
            <div className='row pt-5'>
                <div className='col-sm-12 col-md-6 col-lg-3'>
                    ...
                    <p className="contact">
                        Send us an email at... 
                        <a className='footer-link' href='mailto:hello@codebar.io?Subject=Hello codebar'>hello@codebar.io</a>
                    </p>
                </div>

                <div className='col-sm-12 col-md-6 col-lg-3'>
                    <ul className="list-unstyled ml-0">
                        <li><a className='footer-link' href="https://codebar.io/code-of-conduct" >Code of Conduct</a></li>
                        <li><a className='footer-link' href="https://codebar.io/breach-code-of-conduct" >Breach of Conduct</a></li>
                        <li><a className='footer-link' href="https://codebar.io/effective-teacher-guide" >Coach Guide</a></li>
                        <li><a className='footer-link' href="https://codebar.io/student-guide" >Student Guide</a></li>
                        <li><a className='footer-link' href="http://tutorials.codebar.io/" >Tutorials</a></li>
                        <li><a className='footer-link' href="http://manual.codebar.io/becoming-a-sponsor" >Becoming a Sponsor</a></li>
                        <li><a className='footer-link' href="https://codebar.io/faq" >FAQ</a></li>
                    </ul>
                </div>
                <div className='col-sm-12 col-md-6 col-lg-3'>
                    <ul className="list-unstyled ml-0">
                        <li><a className='footer-link' href="http://stats.codebar.io/" >Stats</a></li>
                        <li><a className='footer-link' href="https://medium.com/the-codelog" >Blog</a></li>
                        <li><a className='footer-link' href="https://medium.com/codebar-stories" >codebar Stories</a></li>
                        <li><a className='footer-link' href="https://codebar.io/coaches" >Coaches</a></li>
            ...
            <div className="row pb-4">
                   <div className="col">
                       <ul className="list-inline registration m-0 p-0">
                           ...
                           <li className="list-inline-item"><a className='footer-link' href="https://codebar.io/cookie-policy" >Cookie Policy</a></li>
                           <li className="list-inline-item"><a className='footer-link' href="https://codebar.io/privacy-policy" >Privacy Policy</a></li>
                       </ul>
                   </div>
            </div>
        </footer>
